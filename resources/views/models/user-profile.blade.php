                        ...
                        <div class="flex justify-start base-profile-dp-modal-wrapper">
                            <div class="display-image-profile-page-wrapper">
                                <img class="select-none object-cover display-image-profile-image"
                                    src="{{ Auth::user()->profile }}" alt="Profile Display" draggable="false"
                                    id="profile-image" />
                            </div>
                            <div>
                                ...
                                <div class="profile-image-avatar-wrapper">
                                    <div class="profile-display-image-wrapper" onclick="handleAvatarImageSelect(this)">
                                        <img class="profile-dp-avtar-image"
                                            src="{{ asset('admins/images/profile/1.svg') }}" alt="Avatar 1"
                                            draggable="false" />
                                    </div>
                                    <div class="profile-display-image-wrapper" onclick="handleAvatarImageSelect(this)">
                                        <img class="profile-dp-avtar-image"
                                            src="{{ asset('admins/images/profile/2.svg') }}" alt="Avatar 2"
                                            draggable="false" />
                                    </div>
                                    <div class="profile-display-image-wrapper" onclick="handleAvatarImageSelect(this)">
                                        <img class="profile-dp-avtar-image"
                                            src="{{ asset('admins/images/profile/3.svg') }}" alt="Avatar 3"
                                            draggable="false" />
                                    </div>
                                    <div class="profile-display-image-wrapper" onclick="handleAvatarImageSelect(this)">
                                        <img class="profile-dp-avtar-image"
                                            src="{{ asset('admins/images/profile/4.svg') }}" alt="Avatar 4"
                                            draggable="false" />
                                    </div>
                                    <div class="profile-display-image-wrapper" onclick="handleAvatarImageSelect(this)">
                                        <img class="profile-dp-avtar-image"
                                            src="{{ asset('admins/images/profile/5.svg') }}" alt="Avatar 5"
                                            draggable="false" />
                                    </div>
                                    <div class="profile-display-image-wrapper" onclick="handleAvatarImageSelect(this)">
                                        <img class="profile-dp-avtar-image"
                                            src="{{ asset('admins/images/profile/6.svg') }}" alt="Avatar 6"
                                            draggable="false" />
                                    </div>
                                    <button type="button"
