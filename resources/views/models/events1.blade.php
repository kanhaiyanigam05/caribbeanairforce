                        ...
                        <div class="base-form-event-wrapper border-box">
                            ...
                            <div class="mb-1 mt-5 flex items-center gap-1">
                                <div>
                                    ...
                                    <p class="reserved-seating-info">Use your venue map to set price tiers for each
                                        section and choose whether attendees can pick their seat.</p>
                                </div>
                                <div>
                                    <div class="caribbean-switch-wrapper">
                                        <input type="checkbox" id="reserved-seating-switch">
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="add-ticket-bottom tickets">
                                                <div class="add-ticket-paid-items default">
                                                                ...
                                                                <div class="item">
                                                                    ...
                                                                    <button class="amenities-btn" type="button"
                                                                        ...
                                                                        <img class="amenities-icon"
                                                                            src="{{ asset("
                                                                                                                                                    uploads/amenities/{$amenity->image}") }}"
                                                                            alt=""
                                                                            draggable="false">
                                                                        <p>{{ $amenity->name }}</p>
                                                                    </button>
                                                    ...
                                                    <div
                                                        ...
                                                        <p class="transition add-ticket-paid-label border-box">Custom
                                                            Amenities</p>

                                                        <div
                                                            class="flex items-start justify-start transition flex-column gap-05 border-box w-full">
                                                            <div class="w-full">
                                                                <input class="custom-amenities-input" type="file"
                                                                    name="custom_amenities" id="custom-amenities"
                                                                    hidden>
                                                                <div class="flex justify-start items-center gap-05">
                                                                    <img class="display-icon"
                                                                        src="{{ asset('admins/images/placeholder-icon.png') }}"
                                                                        alt="" draggable="false">
...
<section class="modal-wrapper show-modal reserved-top-modal hidden">
    <div class="base-modal-wrapper">
        <div class="bg-white reserved-modal">
            <div class="flex justify-between items-center top">
                <h5 class="heading back-btn hidden"><i class="fa-solid fa-arrow-left"></i></h5>
                <h5 class="heading text">Choose a layout type</h5>
                <button type="button" class="close-btn">x</button>
            </div>

            <div class="reserved-layout-type">
                <button type="button" onclick="handleResevedSelection('table-chair')">
                    <img src="https://cdn.evbstatic.com/s3-build/prod/1918174-rc2025-04-02_20.04-py27-6dac8f6/django/images/reserved/quick_start/table-chair.png"
                        alt="">
                    <span>Table & Chair</span>
                </button>
                <button type="button" onclick="handleResevedSelection('sections-rows')">
                    <img src="https://cdn.evbstatic.com/s3-build/prod/1918174-rc2025-04-02_20.04-py27-6dac8f6/django/images/reserved/quick_start/section-row.png"
                        alt="">
                    <span>Sections & Rows</span>
                </button>
                <button type="button" onclick="handleResevedSelection('mixed-seating')">
                    <img src="https://cdn.evbstatic.com/s3-build/prod/1918174-rc2025-04-02_20.04-py27-6dac8f6/django/images/reserved/quick_start/mixed.png"
                        alt="">
                    <span>Mixed Seating</span>
                </button>
                <button type="button" onclick="handleResevedSelection('blank-canvas')">
                    <img src="https://cdn.evbstatic.com/s3-build/prod/1918174-rc2025-04-02_20.04-py27-6dac8f6/django/images/reserved/quick_start/blank.png"
                        alt="">
            ...
            <div class="reserved-layout-options hidden">
                <div id="table-chair" class="layout-type-item">
                    <div>
                        <h4 class="base-heading">Table & Chair</h4>
                        <div>
                            <div class="flex justify-between items-center">
                                <p>Number of tables:</p>
                                <input type="number" class="transition border-box seat-map--input no-of-table" min="1" max="50" value="14">
                            </div>
                        ...
                        <div class="mt-5">
                            <div class="flex justify-between items-center">
                                <p>Seats per table:</p>
                                <input type="number" class="transition border-box seat-map--input no-of-seats" min="1" max="30" value="8">
                            </div>
                ...
                <div id="sections-rows" class="layout-type-item hidden">
                    <div>
                        <h4 class="base-heading">Sections & Rows</h4>
                        <div>
                            <div class="flex justify-between items-center">
                                <p>Number of sections:</p>
                                <input type="number" class="transition border-box seat-map--input no-of-table" min="1" max="50" value="14">
                            </div>
                            <p class="error-text border-box">Add upto 50 sections.</p>
                        </div>
                        <div class="mt-5">
                            <div class="flex justify-between items-center">
                            ...
                            <p class="error-text border-box">Add upto 50 rows.</p>
                        </div>
                        <div class="mt-5">
                            <div class="flex justify-between items-center">
                                <p>Seats per row:</p>
                            ...
                            <p class="error-text border-box">Add upto 50 seats.</p>
                        </div>
                    </div>
                </div>


                <div id="mixed-seating" class="layout-type-item hidden">
                    <div>
                        <h4 class="base-heading">Mixed Seating</h4>

                        <div class="flex flex-col gap-2">
                            <div class="flex flex-col gap-05">
                                <h6 class="text-bold">Sections</h6>
                                <div>
                                    <div class="flex justify-between items-center">
                                        <p>Number of sections:</p>
                                        <input type="number" class="transition border-box seat-map--input no-of-table" min="1" max="50" value="14">
                            ...
                            <div class="flex flex-col gap-05">
                                <h6 class="text-bold">Tables</h6>
                                <div>
                                    <div class="flex justify-between items-center">
                                        <p>Number of tables:</p>
                                        <input type="number" class="transition border-box seat-map--input no-of-table" min="1" max="50" value="14">
                                    </div>
                                    <p class="error-text border-box">Add upto 50 tables.</p>
                                </div>
                                <div class="mt-5">
                                    <div class="flex justify-between items-center">
                                        <p>Seats per table:</p>
                                    ...
                                    <p class="error-text border-box">Add upto 30 seats.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="blank-canvas" class="layout-type-item hidden">
                    <h4 class="base-heading">Blank Canvas</h4>
                </div>
                    ...
                    <div>
                        <div class="stencil-wrapper" id="stencilWrapper">
                            <button class="stencil-btn" type="button">
                                <input type="checkbox" name="stage" id="stage-1" class="hidden toggle-box">
                            ...
                            <button class="stencil-btn" type="button">
                                <input type="checkbox" name="food" id="stage-2" class="hidden toggle-box">
                            ...
                            <button class="stencil-btn" type="button">
                                <input type="checkbox" name="exit" id="stage-3" class="hidden toggle-box">
                            ...
                            <button class="stencil-btn" type="button">
                                <input type="checkbox" name="bathroom" id="stage-4" class="hidden toggle-box">
                            ...
                            <button class="stencil-btn" type="button">
                                <input type="checkbox" name="bar" id="stage-5" class="hidden toggle-box">
                ...
                <div>
                    <button class="show-seat-map-btn w-full text-white transition base-form-event-wrapper-btn border-box create-event-default-btn show" type="button">Continue</button>
                </div>
            </div>
        </div>
        <div class="bg-white seat-map-wrapper hidden">
            <div class="map-head">
                <div class="left">
                    <button class="item seat-modal-back-btn" type="button"><i class="fa-solid fa-arrow-left"></i></button>
                    <button class="item map-item active" type="button" onclick="tabMenuSwitch('tiers-item', this)">Tiers</button>
                    <button class="item map-item" type="button" onclick="tabMenuSwitch('holds-item', this)">Holds</button>
                </div>
            ...
            <div class="map-body">
                ...
                <aside class="right">
                    <div id="tiers-item" class="map-item">
                        <div class="map-ticket-sidebar">
                            <h4 class="add-ticket-heading">Add Tickets</h4>
                            <div class="">
                                <div class="tab-body">
                                    <div class="add-ticket-tab-bottom tab-body-item add-ticket-paid">
                                        ...
                                        <div class="add-ticket-bottom tickets">
                                            <div class="map-ticket-paid-items default">
                                                <div class="flex items-start justify-start mb-1 transition add-ticket-input-item-wrapper flex-column gap-05 border-box">
                                                    <label for="add-ticket-paid-name" class="transition add-ticket-paid-label border-box">Name</label>
                                                    <input type="text" name="package_name[]" id="add-ticket-paid-name" class="w-full transition add-ticket-paid-input event-input border-box"
                                                        placeholder="General Admission">
                                                    <p class="error-text border-box"></p>
                                                </div>
                                                <div class="flex items-start justify-start mb-1 transition add-ticket-input-item-wrapper flex-column gap-05 border-box">
                                                    <label for="add-ticket-paid-available-quantity" class="transition add-ticket-paid-label border-box">Available quantity</label>
                                                    <input type="text" name="package_qty[]" id="add-ticket-paid-available-quantity"
                                                        class="w-full transition add-ticket-paid-input event-input border-box" placeholder="1" oninput="validateInteger(this, 0)"
                                                        onpaste="validateInteger(this, 0)">
                                                    <p class="error-text border-box"></p>
                                                </div>
                                                <div class="flex items-start justify-start mb-1 transition add-ticket-input-item-wrapper flex-column gap-05 border-box">
                                                    <label for="add-ticket-paid-available-quantity" class="transition add-ticket-paid-label border-box">Package Color</label>
                                                    <input type="color" class="w-full transition add-ticket-paid-input event-input border-box" value="black">
                                                    <p class="error-text border-box"></p>
                                                </div>
                                            </div>
                                            <div class="map-ticket-paid-items">
                                                <div class="add-ticket-input-item-wrapper mb-1 transition flex flex-column gap-05 justify-start items-start border-box">
                                                    <label for="add-ticket-paid-name-1744201715337" class="transition border-box add-ticket-paid-label">Name</label>
                                                    <input type="text" name="package_name[]" id="add-ticket-paid-name-1744201715337"
                                                        class="add-ticket-paid-input transition w-full event-input border-box" placeholder="General Admission">
                                                    <p class="error-text border-box"></p>
                                                </div>
                                                <div class="add-ticket-input-item-wrapper mb-1 transition flex flex-column gap-05 justify-start items-start border-box">
                                                    <label for="add-ticket-paid-available-quantity-1744201715338" class="transition border-box add-ticket-paid-label">Available quantity</label>
                                                    <input type="text" name="package_qty[]" id="add-ticket-paid-available-quantity-1744201715338"
                                                        class="add-ticket-paid-input transition w-full event-input border-box" placeholder="1" oninput="validateInteger(this, 0)"
                                                        onpaste="validateInteger(this, 0)">
                                                    <p class="error-text border-box"></p>
                                                </div>
                                                <div class="flex items-start justify-start mb-1 transition add-ticket-input-item-wrapper flex-column gap-05 border-box">
                                                ...
                                                <div class="mb-1 transition flex flex-column gap-05 justify-start items-start border-box">
                                                    <button class="delete-category-btn transition" type="button">
                                                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
                                                            <path d="M200-440v-80h560v80H200Z"></path>
                                                        </svg> Delete Category </button>
                                                </div>
                                            </div>
                                            <div class="map-ticket-paid-items">
                                                <div class="add-ticket-input-item-wrapper mb-1 transition flex flex-column gap-05 justify-start items-start border-box">
                    ...
                    <div id="holds-item" class="map-item hidden">
                        <div class="map-ticket-sidebar">
                            <h4 class="add-ticket-heading">Held</h4>
                            <div class="">
                                <div class="tab-body">
                                    <div class="add-ticket-tab-bottom tab-body-item add-ticket-paid">
                                        <div>
