            ...
            <div class="bg-white" id="create-event-container">
                ...
                <div id="create-event-modal-inner">
                    ...
                    <div id="organizer-name-wrapper" class="modal-inner-content-wrapper border-box">
                        ...
                        <div class="base-form-event-wrapper border-box">
                            <div class="flex items-start justify-start mb-1 transition flex-column gap-05 border-box organizer-item">
                                ...
                                <input type="text" name="organizer_name" id="organizer-name" value="{{ Auth::user()->full_name }}"
                            ...
                            <div class="flex items-start justify-start mb-1 transition flex-column gap-05 border-box organizer-item">
                                ...
                                <input type="email" name="organizer_email" id="organizer-email" value="{{ Auth::user()->email }}"
                                    class="w-full transition event-input border-box" placeholder="demo@nowhere.com" />
                                <p class="error-text border-box"></p>
                            </div>
                            <div class="flex items-start justify-start mb-1 transition flex-column gap-05 border-box organizer-item">
                                <label for="organizer-phone" class="transition border-box">Phone</label>
                                <input type="text" name="organizer_phone" id="organizer-phone" value="{{ Auth::user()->phone }}"
                                    class="w-full transition event-input border-box" placeholder="+91 9876543210" />
                                <p class="error-text border-box"></p>
                            </div>
                        ...
                        <div class="base-form-event-wrapper border-box">
                            <div class="flex items-start justify-start mb-1 transition flex-column gap-05 border-box">
                                ...
                                <input type="text" name="title" id="event-name"
                                    class="w-full transition event-input border-box" placeholder="Enter the name of your event" />
                                <p class="error-text border-box"></p>
                            </div>
                            ...
                            <div class="flex items-start justify-start mb-1 transition flex-column gap-05 border-box">
                                ...
                                <textarea name="ticket_info" id="event-short-description"
                                    class="w-full transition event-input border-box event-short-description" placeholder="Enter a short description of the event" rows="5"></textarea>
                                <p class="error-text border-box"></p>
                            </div>
                        ...
                        <div class="base-form-event-wrapper border-box">
                            ...
                            <div class="hidden mb-1 create-event-type-wapper">
                                <div
                                    ...
                                    <select name="timing" id="schedule-by" class="w-full transition event-input border-box">
                                ...
                                <div
                                    ...
                                    <div class="flex flex-wrap items-start justify-start transition gap-05 custom-pass-area">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        <div class="add-ticket-paid-items mt-2">
                                            <div
                                                ...
                                                <label for="add-pass-name" class=" transition border-box">Pass Name</label>
                                            ...
                                            <div class="mb-1 transition flex flex-column gap-05 justify-start items-start border-box">
                                                <label for="add-pass-day" class=" transition border-box ">Pass Day</label>
                    ...
                    <div id="event-create-tickets-wrapper"
                        ...
                        <p style="margin: 15px 0; font-size: 15px;">Choose a ticket type or build a section with multiple
                            ticket types.</p>
                        <div class="base-form-event-wrapper border-box">
                            <div class="create-tickets-button-main-wrapper">
                                    ...
                                    <button type="button" class="flex mb-1 transition border-box create-tickets-button">
                                        <div class="create-tickets-button-left">
                                            <svg width="63" height="63" viewBox="0 0 63 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="63" height="63" rx="8" fill="#3659E3" fill-opacity="0.08"></rect>
                                            ...
                                            <div class="create-tickets-button-inner-wrapper">
                                                ...
                                                <p class="create-tickets-button-inner-paragraph">Create a ticket that people have to pay
                                                    for.</p>
                                            </div>
                                        </div>
                                        <div>
                                ...
                                <div>
                                    <button type="button" class="flex mb-1 transition border-box create-tickets-button">
                                        <div class="create-tickets-button-left">
                                            <svg width="63" height="63" viewBox="0 0 63 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="63" height="63" rx="6.38" fill="#F2E7FE" fill-opacity="0.8"></rect>
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            <div class="create-tickets-button-inner-wrapper">
                                                ...
                                                <p class="create-tickets-button-inner-paragraph">Create a ticket that no one has to pay
                                                    for.</p>
                                            </div>
                                        </div>
                                        <div>
                                ...
                                <div>
                                    <button type="button" class="flex mb-1 transition border-box create-tickets-button">
                                        <div class="create-tickets-button-left">
                                            <svg width="63" height="63" viewBox="0 0 63 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="63" height="63" rx="6.3" fill="#C5162E" fill-opacity="0.08"></rect>
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            <div class="create-tickets-button-inner-wrapper">
                                                ...
                                                <p class="create-tickets-button-inner-paragraph">Let people pay any amount for their
                                                    ticket.</p>
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <div class="opacity-0 add-ticket-sidebar">
                                ...
                                <div class="add-ticket-tab-wrapper tab-wrapper">
                                    <div class="add-ticket-button-wrapper tab-header">
                                        <button type="button" class="transition add-ticket-button tab-btns">Paid</button>
                                        <button type="button" class="transition add-ticket-button tab-btns">Free</button>
                                        <button type="button" class="transition add-ticket-button tab-btns">Donation</button>
                                    </div>
                                    <div class="tab-body">
                                            ...
                                            <div class="add-ticket-bottom tickets">
                                                <div class="add-ticket-paid-items default">
                                                    <div
                                                        ...
                                                        <input type="text" name="package_name[]" id="add-ticket-paid-name"
                                                    ...
                                                    <div
                                                        ...
                                                        <label for="add-ticket-paid-available-quantity"
                                                            class="transition add-ticket-paid-label border-box">Available quantity</label>
                                                    ...
                                                    <div
                                                        ...
                                                        <label for="add-ticket-paid-price"
                                                            class="transition add-ticket-paid-label border-box">Ticket Price</label>
                                                        <div class="ticket-price-wrapper">
                                                            <input type="text" name="package_price[]" id="add-ticket-paid-price"
                                                                class="w-full transition add-ticket-paid-price default add-ticket-paid-input event-input border-box"
                                                                placeholder="250" oninput="validatePrice(this)" onpaste="validatePrice(this)">
                                                            <i class="absolute fa-solid fa-dollar-sign"></i>
                                                        </div>
                                                        <p id="add-ticket-paid-price-error" class="error-text border-box"></p>
                                                    </div>
                                                    <div class="flex items-start justify-start mb-1 transition flex-column gap-1 border-box mt-1">
                                                        <p class="transition add-ticket-paid-label border-box">Standard
                                                            Amenities</p>

                                                        <div class="amenities-icon-wrapper">
                                                            @foreach (App\Models\Amenity::where('type', 'static')->get() as $amenity)
                                                                <div class="item">
                                                                    <input type="checkbox" name="amenities[]" value="{{ $amenity->id }}" class="hidden amenities-checkbox">
                                                                    <button class="amenities-btn" type="button" title="{{ $amenity->name }}">
                                                                        <img class="amenities-icon" src="{{ asset("uploads/amenities/{$amenity->image}") }}" alt="" draggable="false">
                                                                        <p>{{ $amenity->name }}</p>
                                                                    </button>
                                                                </div>
                                                            @endforeach
                                                    ...
                                                    <div class="personalized-amenities-wrapper hidden mt-1">
                                                        <div
                                                            ...
                                                            <p class="transition add-ticket-paid-label border-box">Personalized
                                                                Amenities</p>
                                                            <div class="amenities-icon-wrapper"></div>
                                                        </div>
                                                    </div>

                                                    <div class="flex items-start justify-start mb-1 transition flex-column gap-1 border-box custom-amenities-wrapper mt-1">
                                                        <p class="transition add-ticket-paid-label border-box">Custom Amenities</p>

                                                        <div class="flex items-start justify-start transition flex-column gap-05 border-box w-full">
                                                            <div class="w-full">
                                                                ...
                                                                <div class="flex justify-start items-center gap-05">
                                                                    <img class="display-icon" src="{{ asset('admins/images/placeholder-icon.png') }}" alt="" draggable="false">
                                                                    <label class="icon-upload-btn" for="custom-amenities">Upload Icon</label>
                                                                </div>
                                                                <p class="error-text border-box img-error"></p>
                                                            </div>
                                                            <input type="text" name="" id="" class="w-full transition event-input border-box custom-amenities-text"
                                        ...
                                        <div class="hidden create-event-item add-ticket-tab-bottom tab-body-item add-ticket-free">
                                            <div class="flex items-start justify-start transition flex-column gap-05 border-box">
                                                <label for="add-ticket-free-available-quantity" class="transition border-box">Available
                                                    quantity</label>
                                                <input type="text" name="free_tickets"
                                                    ...
                                                    oninput="validateInteger(this, 0)" onpaste="validateInteger(this, 0)">
                                                <p class="error-text border-box"></p>
                                            </div>
                                        </div>
                                        <div
                        ...
                        <div class="base-form-event-wrapper border-box">
                            ...
                            <div
                                ...
                                <input type="text" name="city" id="event-venue-city"
                                    class="w-full transition event-venue-city event-input border-box" placeholder="e.g. London" />
                                <p class="error-text border-box"></p>
                            </div>
                            <div
                                class="flex items-start justify-start mb-1 transition item-wrapper flex-column gap-05 border-box">
                        ...
                        <div class="base-form-event-wrapper border-box choose-image-wrapper">
                            <div class="flex justify-start max-w-full base-cover-image-modal-wrapper">
                                <div class="w-full cover-profile-page-wrapper">
                                    <img class="w-full select-none header-image-prev prev-img" src="{{ asset('admins/images/profile/placeholder.png') }}"
                                        alt="Profile Display" draggable="false">
                                </div>
                                <div class="w-full cover-image-avtar-base-wrapper-50">
                                    <label for="cover-input-image" class="w-full">
                                        <button type="button"
                                            ...
                                            <img class="select-none" src="{{ asset('admins/images/plus.svg') }}" alt="" draggable="false">
                                        </button>
                                    </label>
                                    <p class="text-info" style="margin: 15px 0 7px 0;">Please upload image with a resolution of
                                        1024 x 576 pixels for optimal display.</p>
                                    <p class="error-text border-box event-header-error"></p>
                                </div>
                                <div>
                                    <input type="file" name="banner" id="cover-input-image" class="hidden input-img event-header-input-image">
                                </div>
                            </div>
                            <div class="flex items-start justify-start transition flex-column gap-05 border-box">
                                <!-- 14-11-2024 -->
                            ...
                            <div class="flex items-start justify-start mb-1 transition flex-column gap-05 border-box">
                                ...
                                <div class="h-full drag-image-main-wrapper">
                                    ...
                                    <input type="file" name="images[]" id="event-banner"
                                        class="hidden input-images-create multi-image-select-add-product-input" multiple="" />
                                    <div class="event-media-display-wrapper">
                                        <div class="select-none display-img-create-order"></div>
                                    </div>
                                </div>
                                <p class="text-info">Please upload images with a resolution of 1024 x 576 pixels for optimal
                                    display.</p>
                    ...
                    <div id="event-payment-wrapper"
                        ...
                        <div class="base-form-event-wrapper border-box">
                            <div class="flex items-start justify-start mb-1 transition flex-column gap-05 border-box">
                                ...
                                <select name="ticket_mode" id="payment-mode" class="w-full transition event-input border-box">
                            ...
                            <div id="purchase-location-wrapper" class="hidden">
                                <div class="flex items-start justify-start mb-1 transition flex-column gap-05 border-box">
                                    ...
                                    <input type="text" name="ticket_location" id="purchase-location"
                                        class="w-full transition event-input border-box" placeholder="e.g. The Blue Moon Cafe" />
                                    <p class="error-text border-box"></p>
                                </div>
                                <div class="flex items-start justify-start mb-1 transition flex-column gap-05 border-box">
                                    <label for="ticket_location_map" class="transition border-box">Ticket Map Location</label>
                    ...
                    <div id="event-create-faq-wrapper"
                        ...
                        <div class="flex items-center justify-between" style="padding: 0 1rem;">
                            ...
                            <button class="create-new-faq-btn" type="button" title="Create A New FAQ"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" height="35px" width="35px" viewBox="0 -960 960 960"
                                    fill="#5f6368">
                                    <path
                    ...
                    <div id="event-preview-wrapper"
                            ...
                            <section
                                ...
                                <div>
                                    <div class="swiper carousel">
                                        ...
                                        <div class="swiper-button-next bg-primary shadow-2xl px-[22px] py-2 rounded-full">
                                            <i class="text-sm text-white fa-solid fa-chevron-right"></i>
                                        </div>
                                        <div class="swiper-button-prev bg-primary shadow-2xl px-[22px] py-2 rounded-full">
                                    ...
                                    <!-- Faq Starts Here -->
                                    <div class="my-10">
                                        <h2 class="my-5 text-2xl font-bold text-black capitalize screen768:text-3xl">Frequently
                                            Asked Questions</h2>
                                        <div class="faq-wrapper event-prev-faq-item-wrapper">
                                            <div class="border-b border-gray-100 faq-item">
                                                <div
                                                    ...
                                                    <h3 class="text-lg font-semibold">Will there be food and drinks available?</h3>
                                                    <span class="text-gray-500">
                                                        <i class="fa-solid fa-plus faq-expand-collapse-icon"></i>
                                                    </span>
                                                </div>
                                                <div class="faq-answer-wrapper hide-faq-answer">
                                                    <p class="py-4 pr-4 text-gray-700">Yes, we’re pleased to offer a selection of food and
                                                        drinks throughout the event! Guests can enjoy a catered lunch featuring a variety of
                                                        options, including gourmet sandwiches, seasonal salads, and a selection of desserts.
                                                        There will also be complimentary beverages, including coffee, tea, and soft drinks.
                                                        Additionally, we have options to accommodate various dietary preferences, including
                                                        vegetarian, vegan, and gluten-free choices. We want to ensure everyone has a
                                                        delightful experience, so feel free to reach out if you have any specific dietary
                                                        needs!</p>
                                                </div>
                                            </div>
                                            <div class="border-b border-gray-100 faq-item">
                                                <div
                                                    class="flex items-center justify-between py-4 pr-4 cursor-pointer faq-question-wrapper">
                                                    <h3 class="text-lg font-semibold">Are children allowed at the event?</h3>
                                                    <span class="text-gray-500">
                                                        <i class="fa-solid fa-plus faq-expand-collapse-icon"></i>
                                                    </span>
                                                </div>
                                                <div class="faq-answer-wrapper hide-faq-answer">
                                                    <p class="py-4 pr-4 text-gray-700">Yes, children are welcome at the event! We
                                                        encourage families to join us for a fun and engaging experience. Children under the
                                                        age of 12 can attend for free, but we kindly ask that they be accompanied by an
                                                        adult at all times. There will also be designated activities and areas for kids to
                                                        enjoy, ensuring that everyone has a great time! If you have any questions about
                                                        specific arrangements for children, please feel free to reach out.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div
                            ...
                            <div class="hgt6d">
                                <button type="button" class="text-white transition base-prev-event-wrapper-btn border-box"
                                    onclick="handleEventEditAction()">
                                    <i class="fa-solid fa-pen"></i>
                                </button>
                                <div class="hidden details-edit-event-wrapper">
                                    <button type="button" onclick="handleEventFormNextSlide(-1);">Organizer's Information</button>
                            ...
                            <button type="submit" class="text-white potransition base-prev-event-wrapper-btn border-box">
