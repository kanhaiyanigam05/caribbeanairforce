                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;">
                                    <img width="250" src="{{ asset($data->logo) }}" title="Unifying Caribbean People Socially Mentally $ Economically" style="margin-top: 26px;" alt="logo">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="padding:0 35px;">
                                    ...
                                    @if($role == 'superadmin')
                                            A new user has registered with following details.
                                    @else
                                            Thank you for registering with us. We are delighted to welcome you on board.
                                            Your registration has been successfully completed, and you are now part of our
                                            esteemed family.
                                    @endif
                                    </p>
                                    <p
                                    ...
                                    @else
                                        <a target="_blank" href="{{ $verificationUrl }}"
                                           style="background: #e60000;text-decoration: none !important;font-weight: 600;margin-top: 32px;color:
                                                     #fff;text-transform: capitalize;font-size: 19px;padding: 14px 30px;display: inline-block;border-radius: 5px;">
