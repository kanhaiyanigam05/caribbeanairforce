    ...
    <main class="full-width bg-black flex justify-center items-center py-3 transition">
        <div class="relative flex justify-center items-center transition">
            ...
            <section id="login-wrapper" class="flex flex-column items-center transition">
                ...
                <h1 class="text-white text-center text-3xl font-bold transition">Email Verification</h1>
                <p>Please verify your email address by clicking the link sent to your email. If you did not receive the email, click the button below to request another.</p>
                <form action="{{ route('verification.send') }}" method="post" class="w-full transition resend-verification"
                      id="forget-password-form">
                    @csrf
                    <div class="mb-08rem w-full transition">
                        <button class="form-login-btn text-black transition" type="submit">Resend Verification Email</button>
                    </div>
