...
<?php $__env->startPush('css'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('asset/css/custom-check-out-calendar/custom-check-out-calendar1.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('asset/css/tailwind/tw.css')); ?>">
    
    <link rel="stylesheet" href="<?php echo e(asset('asset/css/ticket1.css')); ?>">
...
<?php $__env->startSection('main'); ?>
    ...
    <form action="<?php echo e(route('paypal.form')); ?>" method="post" id="checkout-form">
        <?php echo csrf_field(); ?>
            ...
            <div class="checkout-multi-step-item">
                <div class="relative flex items-center justify-center check-out-main-section">
                    <img class="object-cover w-full h-auto select-none check-out-main-section-bg-img"
                         src="<?php echo e(asset('asset/images/ticket-bg.png')); ?>" alt="" draggable="false">
                        ...
                        <div class="flex items-center justify-center gap-5 check-out-box">
                            <div class="check-out-box-inner-wrapper">
                                <img class="object-cover w-full mx-auto rounded-sm select-none event-aside-check-out-img"
                                     style="max-width:500px" src="<?php echo e($event->image); ?>" alt="" draggable="false">
                            </div>
                                    ...
                                    <div class="flex flex-col gap-4">
                                        <div class="flex flex-col gap-1 detail-item">
                                            <label for="fname" class="text-white font-medium detail-item-label">First
                                                Name*</label>
                                            <input type="text" name="fname" <?php if(auth()->guard()->check()): ?> value="<?php echo e(Auth::user()->fname); ?>" <?php endif; ?>
                                            id="fname"
                                        ...
                                        <div class="flex flex-col gap-1 detail-item">
                                            <label for="lname" class="text-white font-medium detail-item-label">Last
                                                Name*</label>
                                            <input type="text" name="lname" <?php if(auth()->guard()->check()): ?> value="<?php echo e(Auth::user()->lname); ?>" <?php endif; ?>
                                            id="lname"
                                                   class="w-full detail-item-input bg-white text-black rounded px-2 py-1 outline-none"
                                        ...
                                        <div class="flex flex-col gap-1 detail-item">
                                            ...
                                            <input type="email" name="email" <?php if(auth()->guard()->check()): ?> value="<?php echo e(Auth::user()->email); ?>"
                                                   <?php endif; ?> id="email"
                                                   class="w-full detail-item-input bg-white text-black rounded px-2 py-1 outline-none"
                                        ...
                                        <div class="flex flex-col gap-1 detail-item">
                                            <label for="pnumber" class="text-white font-medium detail-item-label">Phone
                                                Number*</label>
                                            <input type="text" name="phone" <?php if(auth()->guard()->check()): ?> value="<?php echo e(Auth::user()->phone); ?>" <?php endif; ?>
                                            id="pnumber"
                                                   class="w-full detail-item-input bg-white text-black rounded px-2 py-1 outline-none"
            ...
            <div class="checkout-multi-step-item">
                <div class="relative flex items-center justify-center check-out-main-section">
                    <img class="object-cover w-full h-auto select-none check-out-main-section-bg-img-3"
                         src="<?php echo e(asset('asset/images/ticket-bg.png')); ?>" style="min-height:1230px" alt="" draggable="false">
...
<?php $__env->startPush('js'); ?>
    ...
    <script src="<?php echo e(asset('asset/js/seating_plan/konva-loader.js')); ?>"></script>
    <script src="<?php echo e(asset('asset/js/general.js')); ?>"></script>
    <script src="<?php echo e(asset('asset/js/check-out.js')); ?>"></script>
    <script>
...
<?php echo $__env->make('layout.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\caribbean-airforce\resources\views/ticket.blade.php ENDPATH**/ ?>