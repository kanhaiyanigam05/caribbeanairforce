                        ...
                        <div class="base-form-event-wrapper border-box">
                            ...
                            <div class="venue-map-wrapper">
                                <div class="venue-map-container create-venue-map hidden">
                                    <img src="https://showcaseonline.xyz/caribbean-airforce/abc.png"
                                         alt="Venue Map Image" class="venue-map-image">
                                ...
                                <div class="venue-map-container edit-venue-map hidden">
                                    ...
                                    <p class="venue-map-description">Please, go to your seating map and edit to start
                                        creating tickets</p>
                                    <button type="button" id="launch-venue-map-designer"
                                            class="text-white transition base-form-event-wrapper-btn border-box create-event-default-btn">
                    ...
                    <div id="event-create-tickets-wrapper"
                        ...
                        <div class="base-form-event-wrapper border-box">
                            ...
                            <div class="add-ticket-sidebar-overlay show flex hidden"
                                ...
                                <div id="modalAmenties"
                                     class="bg-white rounded-lg shadow-lg amenties-modal show hidden">
                ...
                <div class="venue-map-slider-wrapper">
                    ...
                    <div class="reserved-layout-options hidden">
                                ...
                                <div class="mt-5 table">
                                    <div>
                                        <div class="flex justify-between items-center">
                                            ...
                                            <input type="number"
                                                   class="transition event-input border-box seat-map--input no-of-table"
                                                   name="tables" min="1" max="50" value="14">
                                        </div>
                                    ...
                                    <div class="mt-5">
                                        <div class="flex justify-between items-center">
                                            <p>Seats per table:</p>
                                            <input type="number"
                                                   class="transition event-input border-box seat-map--input no-of-seats"
                                                   name="seats" min="1" max="30" value="8">
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="stencil-wrapper" id="stencilWrapper">
                                                <button class="stencil-btn" type="button">
                                                    <input type="checkbox" name="seating-amenities[]" value="stage"
                                                           id="stage-1" class="hidden toggle-box" checked>
                                                ...
                                                <button class="stencil-btn" type="button">
                                                    <input type="checkbox" name="seating-amenities[]" value="food"
                                                           id="stage-2" class="hidden toggle-box">
                                                ...
                                                <button class="stencil-btn" type="button">
                                                    <input type="checkbox" name="seating-amenities[]" value="exit"
                                                           id="stage-3" class="hidden toggle-box">
                                                ...
                                                <button class="stencil-btn" type="button">
                                                    <input type="checkbox" name="seating-amenities[]"
                                                           value="bathroom" id="stage-4" class="hidden toggle-box">
                                                ...
                                                <button class="stencil-btn" type="button">
                                                    <input type="checkbox" name="seating-amenities[]" value="bar"
                                                           id="stage-5" class="hidden toggle-box">
                        ...
                        <div class="mt-5 flex items-start justify-start transition flex-column gap-05 border-box">
                            <button type="button"
                                    class="w-full text-white transition base-form-event-wrapper-btn border-box create-event-default-btn show-seat-map-btn">Next</button>
                        </div>
                    </div>
                                ...
                                <div class="mt-5">
                                    <div>
                                        <div class="flex justify-between items-center">
                                            ...
                                            <input type="number" class="transition event-input border-box no-of-table"
                                    ...
                                    <div class="mt-5">
                                        <div class="flex justify-between items-center">
                                            <p>Seats per table:</p>
                                            <input type="number" class="transition event-input border-box no-of-seats"
                                    ...
                                    <div class="mt-5">
                                        <div>
                                            ...
                                            <div class="stencil-wrapper" id="stencilWrapper">
                                                <button class="stencil-btn" type="button">
                                                    <input type="checkbox" name="stage" id="stage-6"
                                                           class="hidden toggle-box">
                                                ...
                                                <button class="stencil-btn" type="button">
                                                    <input type="checkbox" name="food" id="stage-7"
                                                           class="hidden toggle-box">
                                                ...
                                                <button class="stencil-btn" type="button">
                                                    <input type="checkbox" name="exit" id="stage-8"
                                                           class="hidden toggle-box">
                                                ...
                                                <button class="stencil-btn" type="button">
                                                    <input type="checkbox" name="bathroom" id="stage-9"
                                                           class="hidden toggle-box">
                                                ...
                                                <button class="stencil-btn" type="button">
                                                    <input type="checkbox" name="bar" id="stage-10"
                                                           class="hidden toggle-box">
                                            ...
                                            <h6 class="also-add text-center">Total: <span
                                                    class="total-tablesxseats">1</span></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="mt-5">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <div class="flex justify-between items-center">
                                                    <p>Number of sections:</p>
                                                    <input type="number"
                                                           class="transition event-input border-box no-of-table" min="1"
                                                           max="50" value="14">
                                                </div>
                                                <p class="error-text border-box">Add up to 50 sections.</p>
                                            </div>
                                            <div class="mt-5">
                                                <div class="flex justify-between items-center">
                                                    ...
                                                    <input type="number"
                                                           class="transition event-input border-box no-of-seats" min="1"
                                                           max="50" value="5">
                                                </div>
                                                <p class="error-text border-box">Add up to 50 rows.</p>
                                            </div>
                                    ...
                                    <div class="mt-5">
                                        <div>
                                            ...
                                            <div class="stencil-wrapper" id="stencilWrapper">
                                                <button class="stencil-btn" type="button">
                                                    <input type="checkbox" name="stage" id="stage-11"
                                                           class="hidden toggle-box">
                                                ...
                                                <button class="stencil-btn" type="button">
                                                    <input type="checkbox" name="food" id="stage-12"
                                                           class="hidden toggle-box">
                                                ...
                                                <button class="stencil-btn" type="button">
                                                    <input type="checkbox" name="exit" id="stage-13"
                                                           class="hidden toggle-box">
                                                ...
                                                <button class="stencil-btn" type="button">
                                                    <input type="checkbox" name="bathroom" id="stage-14"
                                                           class="hidden toggle-box">
                                                ...
                                                <button class="stencil-btn" type="button">
                                                    <input type="checkbox" name="bar" id="stage-15"
                                                           class="hidden toggle-box">
                            ...
                            <div class="top-section">
                                <div class="left">
                                    <button class="item map-item active" type="button"
                                            onclick="tabMenuSwitch('tiers-item', this)" data-value="tier">Tiers
                                    </button>
                                    <button class="item map-item" type="button"
                                            onclick="tabMenuSwitch('holds-item', this)" data-value="hold">Holds
                                    </button>
                                </div>
                                <div class="right">
...
<?php $__env->startPush('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('admins/css/amenities.css')); ?>" type="text/css">
    <style>
        canvas {
...
<?php $__env->startPush('script'); ?>
    ...
    <script src="<?php echo e(asset('admins/js/amenities.js')); ?>"></script>
