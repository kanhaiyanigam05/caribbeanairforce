...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['event' => [], 'admin' => false, 'editable' => false, 'isSuperAdmin' => false, 'varient' => 'card']));
...
foreach (array_filter((['event' => [], 'admin' => false, 'editable' => false, 'isSuperAdmin' => false, 'varient' => 'card']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php if($varient === 'card'): ?>
    <div class="ticket-card-wrapper">
        <?php if($admin): ?>
            <a href="<?php echo e(route('admin.profile', $event->organizer?->username)); ?>" class="ticket-card-header-wrapper">
                <div class="ticket-card-header-inner-wrapper">
                    <img class="ticket-card-header-icon" src="<?php echo e($event->organizer?->profile); ?>" alt="<?php echo e($event->organizer?->full_name); ?>" draggable="false" />
                    <div class="ticket-card-header-icon-content-wrapper">
                        <p class="ticket-card-header-name"><?php echo e($event->organizer?->full_name); ?></p>
                        <p class="ticket-card-header-date"><span><?php echo e($event->created_at?->format('d M')); ?></span> at <span><?php echo e($event->created_at?->format('H:i')); ?></span></p>
                    </div>
                </div>
            </a>
        <?php endif; ?>
        ...
        <div class="ticket-card-body-wrapper">
            <div class="ticket-card-body-image-wrapper">
                <a href="<?php echo e($route); ?>">
                    <img src="<?php echo e($event->image); ?>" alt="Event image for Weekend Wellness Workshop" draggable="false" />
                </a>
                <?php if($editable): ?>
                    <div class="ticket-card-menu-wrapper" onclick="handleTicketCardMenu(this)">
                        <button class="ticket-card-menu-btn" id="event-btn-<?php echo e($event->id); ?>" aria-label="Menu">
                        ...
                        <div class="menu-wrapper">
                                ...
                                <div class="card-menu-dropdown">
                                    <?php if($isSuperAdmin): ?>
                                        <a href="javascript:void(0);"
                                            onclick="handleEventStatus(event, <?php echo e($event->id); ?>, '<?php echo e(\App\Enums\Status::PENDING); ?>')"
                                            <?php if($event->status == \App\Enums\Status::PENDING): ?> class="active" <?php endif; ?>>
                                            <span class="material-symbols-outlined"> pending </span>
                                            <p>Pending</p>
                                        </a>
                                        <a href="javascript:void(0);"
                                            onclick="handleEventStatus(event, <?php echo e($event->id); ?>, '<?php echo e(\App\Enums\Status::ACCEPTED); ?>')"
                                            <?php if($event->status == \App\Enums\Status::ACCEPTED): ?> class="active" <?php endif; ?>>
                                            <span class="material-symbols-outlined"> check </span>
                                            <p>Approve</p>
                                        </a>
                                        <a href="javascript:void(0);"
                                            onclick="handleEventStatus(event, <?php echo e($event->id); ?>, '<?php echo e(\App\Enums\Status::REJECTED); ?>')"
                                            <?php if($event->status == \App\Enums\Status::REJECTED): ?> class="active" <?php endif; ?>>
                                    ...
                                    <?php if($isSuperAdmin): ?>
                                        <a href="javascript:void(0);" onclick="handleEventDelete(event, <?php echo e($event->id); ?>)">
                            ...
                            <div class="ticket-card-menu-dropdown edit-menu-wrapper">
                                <div class="card-menu-dropdown">
                                    ...
                                    <button type="button" onclick="handleCreateEventModalShow(); handleEventFormNextSlide(-1); setEventId(<?php echo e($event->id); ?>);">Edit Organizer Info</button>
                                    <button type="button" onclick="handleCreateEventModalShow(); handleEventFormNextSlide(0); setEventId(<?php echo e($event->id); ?>);">Edit Event Name</button>
                                    <button type="button" onclick="handleCreateEventModalShow(); handleEventFormNextSlide(1); setEventId(<?php echo e($event->id); ?>);">Edit Event Duration</button>
                                    <button type="button" onclick="handleCreateEventModalShow(); handleEventFormNextSlide(2); setEventId(<?php echo e($event->id); ?>);">Edit Ticket Pricing</button>
                                    <button type="button" onclick="handleCreateEventModalShow(); handleEventFormNextSlide(3); setEventId(<?php echo e($event->id); ?>);">Edit Event Location</button>
                                    <button type="button" onclick="handleCreateEventModalShow(); handleEventFormNextSlide(4); setEventId(<?php echo e($event->id); ?>);">Edit Event Description</button>
                                    <button type="button" onclick="handleCreateEventModalShow(); handleEventFormNextSlide(5); setEventId(<?php echo e($event->id); ?>);">Edit Banner Image</button>
                                    <button type="button" onclick="handleCreateEventModalShow(); handleEventFormNextSlide(6); setEventId(<?php echo e($event->id); ?>);">Edit Event Images</button>
                                    <button type="button" onclick="handleCreateEventModalShow(); handleEventFormNextSlide(7); setEventId(<?php echo e($event->id); ?>);">Edit Event Mode</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="cards-share-btn-wrapper">
                    <button class="cards-share-btn" onclick="openShareModal(this, '<?php echo e(route('events.index', $event->slug)); ?>')">
            ...
            <div class="cards-content-wrapper">
                <div class="cards-content-date-time-wrapper">
                    <a href="<?php echo e($route); ?>">
                        <h4 class="cards-content-date"><?php echo e($event->title); ?></h4>
                    </a>
                    <?php if($event->category): ?>
                        <h5 class=""><?php echo e($event->category?->title); ?></h5>
                    <?php endif; ?>
                    <?php if($event->next_slot): ?>
                        <p class="cards-content-time">
                            <?php if($event->type === 'pass'): ?>
                                <?php echo e($event->next_slot ? "{$event->next_slot?->start_date?->format('D, M j')}, {$event->next_slot?->start_time?->format('h:i A')}" : ''); ?>

                            <?php else: ?>
                                <?php echo e($event->next_slot ? "{$event->next_slot?->date?->format('D, M j')}, {$event->next_slot?->start_time?->format('h:i A')}" : ''); ?>
                ...
                <p class="ticket-card-price">$ <?php echo e($event->price); ?> <span class="text-black">(starts from)</span></p>


                <div class="cards-content-date-time-wrapper">
                    <div class="cards-ticket-followers-wrapper">
                        <div class="cards-ticket-followers-image-wrapper">
                            <?php $__currentLoopData = $event->organizer?->followers?->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $follower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <img class="cards-ticket-followers-image" draggable="false"
                                    src="<?php echo e($follower->profile); ?>" alt="<?php echo e($follower->full_name); ?>" />
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <?php $totalFollowers = $event->organizer?->followers?->count(); ?>
                        <p><?php echo e(\App\Helpers\Setting::formatFollowers($totalFollowers)); ?> follower<?php echo e($totalFollowers > 1 ? 's' : ''); ?></p>
                    </div>
                    <div class="cards-ticket-joined-wrapper">
                        <p><?php echo e(\App\Helpers\Setting::formatFollowers($event->bookings_count)); ?> <?php echo e($event->bookings_count > 1 ? 'people' : 'person'); ?> joined ðŸ“ˆ</p>
                        <p><?php echo $event->paid_tickets <= 10 && $event->paid_tickets > 0 ? $event->paid_tickets . ' Tickets Left' : ''; ?> </p>
                        <?php if($event->ticket_info): ?>
                            <p><?php echo e($event->ticket_info); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="cards-ticket-read-more-wrapper">
                    ...
                    <?php if($event->paid_tickets !== null && $event->paid_tickets > 0 && $event->next_slot): ?>
                        <?php if(Auth::check() && Auth::user()->role == \App\Enums\Role::SUPERADMIN): ?>
                            <?php if(Route::currentRouteName() === 'events.index'): ?>
                                <a class="cards-ticket-read-more" href="<?php echo e(route('ticket.booking', $ticket)); ?>">
                                    Buy Ticket
                                </a>
                            <?php endif; ?>
                        <?php else: ?>
                    ...
                    <?php if(Auth::user()?->role === \App\Enums\Role::SUPERADMIN || Auth::id() === $event->organizer_id): ?>
                        <a class="cards-ticket-read-more" href="<?php echo e(route('download.qr.code', $event->slug)); ?>">Download QR Code</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php elseif($varient === 'list'): ?>
    <?php if (! $__env->hasRenderedOnce('2681aa6c-ccaf-4735-ba25-cac67655aaa3')): $__env->markAsRenderedOnce('2681aa6c-ccaf-4735-ba25-cac67655aaa3'); ?>
        ...
        <?php $__env->stopPush(); ?>
    <?php endif; ?>
    <div <?php echo e($attributes->merge(['class' => 'landscape-card-item'])); ?>>
        <div class="">
            <div class="left-side">
                <div class="left-side-top-wrapper">
                    <a href="<?php echo e($route); ?>" class="title"><?php echo e($event->title); ?></a>
                    <?php if($event->category): ?>
                        <h5 class=""><?php echo e($event->category?->title); ?></h5>
                    <?php endif; ?>
                    <p class="timing">
                ...
                <div class="organizer-wrapper">
                    <p class="organizer"><?php echo e($event->organizer?->full_name); ?></p>
                    <div class="following-wrapper">
                        <img class="cards-ticket-followers-image" draggable="false" src="<?php echo e($event->organizer?->profile); ?>" alt="<?php echo e($event->organizer?->full_name); ?>" />
                        <?php $totalFollowers = $event->organizer?->followers?->count(); ?>
                        <p><?php echo e(\App\Helpers\Setting::formatFollowers($totalFollowers)); ?> follower<?php echo e($totalFollowers > 1 ? 's' : ''); ?></p>
                    </div>
                </div>
        ...
        <div class="right-side">
            <img src="<?php echo e($event->image); ?>" alt="<?php echo e($event->title); ?>" draggable="false" loading="lazy">
            <div class="share-like">
                <?php $ticket = \Illuminate\Support\Facades\Crypt::encrypt($event->slug); ?>
                <?php if($event->paid_tickets !== null && $event->paid_tickets > 0 && $event->next_slot): ?>
                    <?php if(Auth::check() && Auth::user()->role == \App\Enums\Role::SUPERADMIN): ?>
                        <?php if(Route::currentRouteName() === 'events.index'): ?>
                            <a class="cards-ticket-read-more" style="width: fit-content;font-weight: 500;padding: 6px 20px;" href="<?php echo e(route('ticket.booking', $ticket)); ?>">Buy Ticket</a>
                        <?php endif; ?>
                    <?php else: ?>
                        <a class="cards-ticket-read-more" style="width: fit-content;font-weight: 500;padding: 6px 20px;" href="<?php echo e(route('ticket.booking', $ticket)); ?>">Buy Ticket</a>
                    <?php endif; ?>
                ...
                <?php endif; ?>
                <button type="button" onclick="openShareModal(this, '<?php echo e(route('events.index', $event->slug)); ?>')"><i class="fa-solid fa-share-nodes"></i></button>
            </div>
        </div>
    </div>
<?php endif; ?>
<?php if (! $__env->hasRenderedOnce('46632e0e-b57e-455a-8bb9-7e907eb59be5')): $__env->markAsRenderedOnce('46632e0e-b57e-455a-8bb9-7e907eb59be5'); ?>
    ...
    <?php $__env->startPush('style'); ?>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('admins/css/cards.css')); ?>">
    <?php $__env->stopPush(); ?>
        ...
        <?php if($admin): ?>
            ...
            <script>
                function handleEventDelete(e, id) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: `<?php echo e(route('admin.events.destroy', ':id')); ?>`.replace(':id', id),
                                type: 'POST',
                                data: {
                                    _method: 'DELETE',
                ...
                function setEventId(id) {
                    $.ajax({
                        type: 'GET',
                        url: `<?php echo e(route('admin.events.edit', ':id')); ?>`.replace(':id', id),
                        success: function({
                            success,
                            event
                        }) {
                            ...
                            if (success) {
                                ...
                                if (event.amenities.length > 0) {
                                    ...
                                    for (let i = 0; i < event.amenities.length; i++) {
                                        if (event.amenities[i].type === 'custom') {
                                            const image = `<?php echo e(asset('uploads/amenities/')); ?>/${event.amenities[i]?.image}`;
                                            const amenityHtml = `
                                                <div class="item">
                                ...
                                // Step 6
                                event.banner && $form.find('.header-image-prev').attr('src', `<?php echo e(asset('uploads/events')); ?>/${event.banner}`).attr('data-src',
                                    `<?php echo e(asset('uploads/events')); ?>/${event.banner}`);
                                ...
                                event.images?.forEach(image => {
                                    ...
                                    <div class="media-container" style="position: relative; display: inline-block; margin: 5px;" id="image-${image.id}">
                                        <video src="<?php echo e(asset('uploads/events')); ?>/${image.image}" controls="" class="media-item" draggable="false" style="width: 100px; height: 100px; object-fit: cover; margin: 5px;"></video>
                                ...
                                `;
                                        ...
                                        imgElement = `
                                    <div class="media-container" style="position: relative; display: inline-block; margin: 5px;" id="image-${image.id}">
                                        <img src="<?php echo e(asset('uploads/events')); ?>/${image.image}" class="media-item" draggable="false" style="width: 100px; height: 100px; object-fit: cover; margin: 5px;">
                                        <i onclick="handleEventImageDelete(event, ${image.id})" class="fa-solid fa-trash a-icon no-bg" style="position: absolute; top: 10px; right: 10px;"></i>
                                    </div>
                                `;
                                    }
                                ...
                                event.ticket_mode === `<?php echo e(\App\Enums\TicketMode::OFFLINE); ?>` && $form.find('#purchase-location-wrapper').removeClass('hidden');
                                ...
                                event.images?.forEach(image => {
                                    bannerMedia.push({
                                        src: `<?php echo e(asset('uploads/events')); ?>/${image.image}`,
                                        type: image.type,
                                    });
                                });
                                const faqs = [];
                ...
                function handleEventImageDelete(event, eventId) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: `<?php echo e(route('admin.events.destroy.image', ':id')); ?>`.replace(':id', eventId),
                                type: 'POST',
                                data: {
                                    _method: 'DELETE',
                                    _token: "<?php echo e(csrf_token()); ?>",
                ...
                function handleEventStatus(event, eventId, status) {
                    ...
                    $.ajax({
                        url: `<?php echo e(route('admin.events.status', ':id')); ?>`.replace(':id', eventId),
                        type: 'POST',
                        data: {
                            _method: 'PUT',
                            _token: "<?php echo e(csrf_token()); ?>",
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH E:\laragon\www\caribbean-airforce\resources\views/components/card.blade.php ENDPATH**/ ?>