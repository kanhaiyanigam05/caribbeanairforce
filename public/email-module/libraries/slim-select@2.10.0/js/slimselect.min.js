    ...
    constructor(t) {
      t || (t = {}),
        ...
        (this.optgroupLabelText =
          t.optgroupLabelText || "ss-optgroup-label-text"),
  ...
  class l {
    ...
    setSelectedBy(t, e) {
      ...
      const o = e.map((e) => {
        var s;
        return (
          (null === (s = l.find((s) => s[t] === e)) || void 0 === s
            ? void 0
            : s.id) || ""
        );
      });
  ...
  class o {
    ...
    updateClassStyles() {
      ...
      ("relative" !== this.settings.contentPosition &&
        "fixed" !== this.settings.contentPosition) ||
    ...
    renderSingleValue() {
      ...
      if (e) {
        ...
        t.classList.add(this.classes.single),
          e.html ? (t.innerHTML = e.html) : (t.innerText = e.text),
    ...
    renderMultipleValues() {
      ...
      for (let s = 0; s < e.length; s++) {
        ...
        i &&
          (this.settings.keepOrder || 0 === t.length
    ...
    searchDiv() {
      ...
      if (
        (this.settings.showSearch ||
          (t.classList.add(this.classes.hide), (e.readOnly = !0)),
        (e.type = "search"),
    ...
    renderOptions(t) {
      if (((this.content.list.innerHTML = ""), 0 === t.length)) {
        ...
        return (
          t.classList.add(this.classes.search),
          this.callbacks.addable
            ? (t.innerHTML = this.settings.addableText.replace(
                "{value}",
      ...
      if (this.settings.allowDeselect && !this.settings.isMultiple) {
        this.store.filter((t) => t.placeholder, !1).length ||
    ...
    moveContentAbove() {
      ...
      (this.content.main.style.margin = "-" + (t + e - 1) + "px 0px 0px 0px"),
        (this.content.main.style.top =
          s.top +
          s.height +
          ("fixed" === this.settings.contentPosition ? 0 : window.scrollY) +
          "px"),
        (this.content.main.style.left =
          s.left +
          ("fixed" === this.settings.contentPosition ? 0 : window.scrollX) +
          "px"),
  ...
  return class {
    constructor(e) {
      ...
      this.selectEl.dataset.ssid && this.destroy(),
        ...
        (this.cssClasses = new t(e.cssClasses));
      const n = [
        "afterChange",
        "beforeOpen",
        "afterOpen",
      ...
      for (const t in e.events)
        e.events.hasOwnProperty(t) &&
          (-1 !== n.indexOf(t)
            ? (this.events[t] = s(e.events[t], 100))
            : (this.events[t] = e.events[t]));
      (this.settings.disabled = (
        null === (i = e.settings) || void 0 === i ? void 0 : i.disabled
      )
        ? e.settings.disabled
