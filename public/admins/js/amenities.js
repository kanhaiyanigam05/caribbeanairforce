...
const fetchAmenities = async () => {
    ...
    const response = await fetch(`${origin}/amenities`);
    ...
    const html = `
     <div class='modal_area_${selectedId} modal_area' >
                                        <div class="p-8 relative ">
                                            ...
                                            <div class="amenities-card-area mt-1" data-id=${selectedId}>
                                            </div>
                                            <div class="p-2 custom-amenities-card-area hidden">
                                                ...
                                                <input class="custom-amenities-name-input" type="text"
                                                    placeholder="Free WiFi" />
                                                <button type="button" onclick="handleCreateCustomAmenties(${selectedId})"
                                                    class="custom-amenities-create-button">CREATE</button>
                                            </div>
                                        </div>
                                        <div class="flex w-full">
                                            <button class="create-custom-amenities-btn" type="button"
                                                onclick="handleOpenCustomAmenties(${selectedId})">Create Custom Amenities</button>
                                            <button class="custom-amenities-save-btn" onclick="handleSaveAmenties(${selectedId})"
