$(document).ready(function () {
    tinymce.init({
        ...
        valid_elements: "*[*],meta[*]",
        valid_children:
            "+h1[div],+h2[div],+h3[div],+h4[div],+h5[div],+h6[div],+a[div]",
        ...
        toolbar:
            "insertfile undo redo | fontselect | fontsizeselect | styleselect | bold italic | forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image media | ltr rtl",
        content_css: [APP_URL.replace("/index.php", "") + "/core/css/all.css"],
        body_class: "list-page bg-slate-800",

        external_filemanager_path:
            APP_URL.replace("/index.php", "") + "/filemanager2/",
        filemanager_title: "Responsive Filemanager",
        external_plugins: {
            filemanager:
                APP_URL.replace("/index.php", "") +
    ...
    tinymce.init({
        ...
        extended_valid_elements: "meta[*]",
        valid_children:
            "+body[style],+body[meta],+div[h2|span|meta|object],+object[param|embed]",
        external_filemanager_path:
            APP_URL.replace("/index.php", "") + "/filemanager2/",
        filemanager_title: "Responsive Filemanager",
        external_plugins: {
